...
export class IFrameWindow implements IWindow {
    ...
    public constructor({
        ...
        this._frame.style.right = "5px";
        this._frame.style.top = "5px";
        this._frame.width = "32px";
        this._frame.height = "32px";
        this._frame.style.borderRadius = "50%";
        this._frame.style.backgroundColor = "#ff00ff44";
